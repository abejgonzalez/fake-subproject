...
latex_documents = [
    (master_doc, 'ucbbardoc.tex', u'Fake Project',
...
man_pages = [
    (master_doc, 'ucbbardoc', u'Fake Project',
     [author], 1)
]
